...
import com.github.cesarb98.fiaptodolist.util.formatarDataHora
...
private fun ConfirmarExclusaoDialog(
    ...
    AlertDialog(
        ...
        text = { Text("Tem certeza que deseja excluir a tarefa \"${tarefa.titulo}\"? Essa ação não pode ser desfeita.") },
        confirmButton = {
